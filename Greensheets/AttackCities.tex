...
\begin{document}
\name{\gAttackCities{}}
Currently, all players are away from home except for \cGrandma{\intro}, but you have plans to maneuver allies or minions to take advantage of another player's absence.  
They have undoubtedly hired help to guard their city in their absence -- extra police, D-list superhumans, or minions, but these defenders can be outmaneuvered if you play your hand correctly.
...
Every five minutes (rounded down) between the time your allies get into position and the time you place the call will reduce your offense score by one.
...
defense score $\ge$ offense score & \begin{tabular}{l}
					The defenders prevail, but there is no trace of the attackers. \\
