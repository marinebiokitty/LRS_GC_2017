...
\NEW{MemFold}{\mTest}{
  ...
  \s\MYtext	{This is a Test of a fold-n-staple memory packet}
	 ...
	 \NEW{MemFold}{\mOSTalkYS}{
  	\s\MYname	{Open if you talk with <NAME> } %\cYS{}
  	\s\MYtext	{When you hear \cYS{}'s voice. You realize that this is your former trainee Surge from the Chicago Incident. \cYS{\They} look different from all those years ago, but you are sure its the same person.   } 
		}
		
		\NEW{MemFold}{\mTweenTalkYS}{
  	\s\MYname	{Open if you talk with <NAME> about their <NAME> super powers } % \cYS{} \cYS{\their}
  	\s\MYtext	{After talking with \cYS{} about their \cYS{\their} super powers before you realize that you remember another super having those powers. You think you might should check the Super Know Website. } 
		}
