...
\NEW{MemEnvelope}{\mBecomeHero}{
	\s\MYname{Open if you decide to become a hero.}
	\s\MYtext{Use the \aMoralStand{} ability now.  At the end of your speech, announce ``I, {\emph Your Name Here}, declare I am a superhero, with the name {\emph Choose Superhero Name Here}!''}
	\s\MYabils{\aMoralStand{}}
	\s\MYblues{\bHeroLeague{}}
}

\NEW{MemEnvelope}{\mBecomeVillain}{
	\s\MYname{Open if you decide to become a villain.}
	\s\MYtext{Use the \aMonologue{} ability now.  At the end of your speech, announce ``I, {\emph Your Name Here}, declare I am a supervillain, with the name {\emph Choose Superhero Name Here}!''}
