...
\NEW{MemEnvelope}{\mBecomeHero}{
	...
	\s\MYtext{Use the \aMoralStand{} ability now.  At the end of your speech, announce ``I, {\emph Your Name Here}, declare I am a superhero, with the name {\emph Choose Superhero Name Here}!''  You are now a hero.  Announce whether or not you choose to join the \cHeroLeague{} immediately.  If you do, you may wish to publish a press release about your decision, which would benefit the \cHeroLeaguel{}.}
...
\NEW{MemEnvelope}{\mBecomeVillain}{
	...
	\s\MYtext{Use the \aMonologue{} ability now.  At the end of your speech, announce ``I, {\emph Your Name Here}, declare I am a supervillain, with the name {\emph Choose Superhero Name Here}!''  You are now a villain.  Announce whether or not you choose to join the \cVillainCompact{} immediately.  If you do, you may wish to publish a press release about your decision, which would benefit the \cVillainCompact{}.}
