...
\NEW{Sign}{\sLivingRoom}{
 ...
 \NEW{Sign}{\sLair}{
  ...
  \s\MYloc	{10-250}
  \s\MYtext	{An indication of the League of Heroes status.}
  } 
  
       \NEW{Sign}{\sChrisSign}{
  \s\MYname	{Try Me}
  \s\MYloc	{10-250}
  \s\MYtext	{Your next clue is here.}
  } 
  ...
  \s\MYname	{Gallery}
  \s\MYloc	{10-250}
  \s\MYtext	{A gallery of rare and valuable artwork that Grandma has stolen.}
  } 
