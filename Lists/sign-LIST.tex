...
\NEW{Sign}{\sLivingRoom}{
 ...
 \NEW{Sign}{\sLair}{
  ...
  \s\MYloc	{10-250}
  \s\MYtext	{A field of bullets that fire as soon as you cross into the bullet zone.}
  } 
  ...
  \s\MYname	{Try Me}
  \s\MYloc	{10-250}
  \s\MYtext	{It's Chris Hemsworth! His entire body is encased in a solid cube of steel. He's trying to tell you something through the gag in his mouth.}
  } 
  
        \NEW{Sign}{\sArtRoom}{
  \s\MYname	{Gallery}
  \s\MYloc	{10-250}
  \s\MYtext	{A gallery of rare and valuable artwork that Grandma has acquired.}
  } 
  ...
  \s\MYloc	{10-250}
  \s\MYtext	{Delicious food lives here.}
  } 
  ...
  \s\MYloc	{10-250}
  \s\MYtext	{Steal the Bag of Holding that belongs to OS and bring it to me. The first person who presents it to me will win the final prize}
  }
