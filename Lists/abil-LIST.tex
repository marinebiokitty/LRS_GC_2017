...
\NEW{Abil}{\aMonologue}{
  ...
  \s\MYeffect	{Raise your hands above your head and deliver a loud, evil laugh.  You may speak for up to ninety seconds.  Everyone in the room when you begin your monologue must stay in the room and listen to you without interruptions.} % If they're picking a lock etc they can continue.
  }
...
\NEW{Abil}{\aIce}{
  \s\MYname	{Ice Power}
  \s\MYtext	{You can freeze objects and people.}
  \s\MYeffect	{Something something something!}
  }
