...
\NEW{Abil}{\aInvisibility}{
  ...
  \s\MYeffect	{Don a headband or go OOC, which marks you as invisible.  Other players cannot see you, though they can hear you and recognize your voice if you speak.  You can return to visibility any time you like, but cannot stay invisible for longer than five minutes at a time.   Once you become visible again, this ability cannot be used for another minute.}
  }
\NEW{Abil}{\aSpeed}{
...
\NEW{Abil}{\aIrresistible}{
  ...
  \s\MYtext	{Your partner finds you irresistibly attractive.  Usable twice.  Can only target your partner in a preexisting sexual relationship.}
  \s\MYeffect	{Your partner finds you the most interesting thing in the room for one minute, and is compelled to stop what they are doing and converse with you during that time.  Once this ability has been used, you may not use it again for twenty minutes.}
  }
\NEW{Abil}{\aSpecial}{
