...
\NEW{ItemLabel}{\iEngagementRingsl}{
  \s\MYname	{EngagementRings}
  \s\MYnumber	{0000}
  \s\MYtext	{Pretty engagement rings.}
  }
  
\NEW{ItemLabel}{\iBagofHolding}{
  \s\MYname	{BagofHolding}
  \s\MYnumber	{0000}
  \s\MYtext	{An innocuous bag that OS often carries.}
  }
...
\NEW{ItemLabel}{\iFancyUtilityBelt}{
  ...
  \s\MYnumber	{0000}
  \s\MYtext	{Climbing and grappling gear in a sleek set form of belt.}
  }
  
\NEW{ItemLabel}{\iBulletproofCape}{
  \s\MYname	{BulletproofCape}
  \s\MYnumber	{0000}
  \s\MYtext	{Bulletproof cape sample, top of the line.}
  }
