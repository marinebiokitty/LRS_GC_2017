...
\NEW{Item}{\iBulletproofCape}{
  ...
  \s\MYnumber	{0000}
  \s\MYtext	{Top of the line bulletproof cape sample.  You cannot be harmed by bullets while wearing this.}
      \value	{\$10,000}
  \tinker{}
  }
  ...
  %  \s\MYcontents	{I was painted by someone special.} % Is this too obvious?
  \value	{\$30,000}
  \bulky	{2}
  }
  ...
  \s\MYtext	{A mesmerizing installation made of 1962 colored keys.}
   ...
   % this does not compile.  Needs to be an envelope for that to work maybe?  The outside of the item needs to say how to break in!s
      \value	{20000}
  }
