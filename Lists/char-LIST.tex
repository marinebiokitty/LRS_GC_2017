...
\PRESETS{Char}{
  ...
  \newstat\MYinfluence {Influence}{IN}{2}
...
\NEW{PC}{\cTeen}{
  ...
  \s\MYgreens	{}
  \s\MYabils	{}
	\s\MYsuperpower{Super technology}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYcash	{}
...
\NEW{PC}{\cOldest}{
  ...
  \s\MYabils	{\aIce{}\aMonologue{}\aIrresistible{}}
  \s\MYitems	{}
...
\NEW{PC}{\cGrad}{
  ...
  \s\MYinfluence{0}
  \s\MYblues	{\bWorld{}\bSuperFamily{}\bChicagoIncident{}}
  \s\MYgreens	{\gFundStartup{}}
  \s\MYabils	{\aInvisibility{}}
