...
\NEW{PC}{\cGrandma}{
  ...
  \s\MYblues	{\bWorld{}\bVillainCompact{}\bSuperFamily{}\bChicagoIncident{}}
  \s\MYgreens	{\gAttackCities{}\gStealing{}}
...
\NEW{PC}{\cArchitect}{
  ...
  \s\MYsupername{N/A}
  \s\MYblues	{\bWorld{}\bSuperFamily{}\bChicagoIncident{}}
  \s\MYgreens	{}
...
\NEW{PC}{\cOldest}{
  ...
  \s\MYinfluence{2}
  \s\MYblues	{\bWorld{}\bVillainCompact{}\bSuperFamily{}\bChicagoIncident{}}
  \s\MYgreens	{\gDefendCities{}\gStealing{}}
...
\NEW{PC}{\cOS}{
  ...
  \s\MYinfluence{2}
  \s\MYblues	{\bWorld{}\bHeroLeague{}\bSuperFamily{}\bChicagoIncident{}}
